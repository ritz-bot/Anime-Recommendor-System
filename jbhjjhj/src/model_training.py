...
class ModelTraining:
    def __init__(self,data_path):
        ...
        self.experiment = comet_ml.Experiment(
            api_key="Oiu9wPWjR9OWlV3IE1bttJXXO",
            project_name="mlops-project-new-2",
            workspace="ritz-bot"
        )
    ...
    def train_model(self):
        try:
            X_train_array,X_test_arOray,y_train,y_test = self.load_data()
...
class ModelTraining:
    ...
    def train_model(self):
        try:
            ...
            rampup_epochs = 5  # Corrected typo from 'ramup_epochs' for clarity, though not causing error
            sustain_epochs = 0
            exp_decay = 0.8
